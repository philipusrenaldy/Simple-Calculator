...
void m_tambah(), m_kurang(), m_kali(), m_trans(), m_det(), m_inv(), error();
void m_tambah(){
	int m, n, x, y, z;
	system("cls");
	printf("%s", KUNING);
	...
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung penjumlahan dari matriks dengan ukuran maksimal 10 x 10, dan dengan nilai elemen matriks dari -100 hingga 100.\n");
...
void m_kurang(){
	...
	printf("[ a(m, 1) a(m, 2)   ...   a(m, n) ]\n\n");
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung pengurangan dari matriks dengan ukuran maksimal 10 x 10, dan dengan nilai elemen matriks dari -100 hingga 100.\n");
	printf("Silahkan melihat bantuan pada menu utama untuk petunjuk lebih lanjut mengenai aplikasi.\n\n");
	do{
		printf("Masukkan jumlah baris (<= 10)\t: ");
		scanf("%d", &m);
...
void m_kali(){
	...
	printf("[ a(m, 1) a(m, 2)   ...   a(m, n) ]\n\n");
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung perkalian dari matriks dengan ukuran maksimal 10 x 10, dan dengan nilai elemen matriks dari -100 hingga 100.\n");
	printf("Silahkan melihat bantuan pada menu utama untuk petunjuk lebih lanjut mengenai aplikasi.\n\n");
	do{
...
void m_trans(){
	...
	printf("[ a(m, 1) a(m, 2)   ...   a(m, n) ]\n\n");
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung transpos dari matriks dengan ukuran maksimal 10 x 10, dan dengan nilai elemen matriks dari -100 hingga 100.\n");
	printf("Silahkan melihat bantuan pada menu utama untuk petunjuk lebih lanjut mengenai aplikasi.\n\n");
	do{
		printf("Masukkan jumlah baris (<= 10)\t: ");
		scanf("%d", &m);
...
void m_det(){
	...
	printf("[ a(m, 1) a(m, 2)   ...   a(m, n) ]\n\n");
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung determinan dari matriks dengan ukuran maksimal 3 x 3, dan dengan nilai elemen matriks dari -100 hingga 100.\n");
	printf("Silahkan melihat bantuan pada menu utama untuk petunjuk lebih lanjut mengenai aplikasi.\n\n");
	do{
